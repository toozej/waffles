...
//
// This package creates Unix manual pages (man pages) for the waffles LLM toolchain
// orchestrator using the mango-cobra library. It generates properly formatted
...
// for the waffles application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates waffles's command line manpages",
		SilenceUsage:          true,
